...
public class NameColor extends AbstractToolTipPage {
    private final ColorSlider nameSlider;
    public NameColor(EventBus eventBus, KeyUITooltips container, PageManager pageManager) {
        ...
        nameSlider=new ColorSlider(0x00FF00, 0, 0,
                10f,
                60,
                70,
                new ColorSlider.SliderColorChangedListener() {
                    ...
                    public void onValueChanged(int color) {
                        ...
                        keyUI.setNameColor(color);
                    }
                });
        addComponent(nameSlider);
        addComponent(button);
    }
    @Override
    ...
    public void onEvent(String eventType, Object data) {
        if(eventType.equals("rightClickKeyUI")){
            ...
            nameSlider.selectRGB(keyUI.getNameColor());
        }
    }
}